...
import { getYoutubeChannelById } from 'apiSdk/youtube-channels';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Youtube Channel Detail View
          </Text>
          {hasAccess('youtube_channel', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/youtube-channels/edit/${data?.id}`} passHref legacyBehavior>
              <Button
